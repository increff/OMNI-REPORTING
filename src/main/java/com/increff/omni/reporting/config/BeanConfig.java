...
/**
 * <B>
 *     make sure you don’t have an @Configuration class annotated with @EnableWebMvc! This was causing Spring MVC to
 *     load and ignore our Spring Boot configuration.
 * </B>
 */
@Configuration
@EnableScheduling
