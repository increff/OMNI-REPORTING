...
//import com.increff.omni.reporting.commons.AuditApi;
...
public class TestConfig {
    ...
    private ClientHttpRequestFactory getRequestFactory(){
         ...
         * requests are supposed to make external calls, we have used these decisively.
        ...
        ConnectionKeepAliveStrategy myStrategy = (httpResponse, httpContext) -> {
            ...
            return TimeValue.ofSeconds((30 * 1000L));
        };
        ...
        // TODO: 27/06/23 use proper time out
