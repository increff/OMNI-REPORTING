...
public class ClickHouseConnectionApiTest extends AbstractTest {
    ...
    public void testGetConnectionInvalidHost() {
        ApiException exception = assertThrows(ApiException.class, () ->
                clickHouseConnectionApi.getConnection("invalid-host:8123/default", "user", "pass"));
    ...
    public void testGetStatementInvalidQuery() throws ApiException {
        ...
        try {
            Connection connection = clickHouseConnectionApi.getConnection("localhost:8123/default", "default", "");
